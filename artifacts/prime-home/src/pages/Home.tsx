      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-gradient-to-br from-stone-900 via-stone-800 to-amber-950">
        ...
        <div className="relative z-10 container mx-auto px-4 py-24">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <Badge className="mb-4 bg-amber-500/20 text-amber-300 border border-amber-500/30 hover:bg-amber-500/30">
              Luxury Home Decor · Lebanon
            </Badge>
      ...
      <section className="py-20 bg-stone-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Truck, title: "Nationwide Delivery", desc: "Fast, reliable delivery across all Lebanon. Free shipping on orders over $50." },
              { icon: Shield, title: "Quality Guaranteed", desc: "Every product is carefully sourced and inspected. We stand by what we sell." },
              { icon: RotateCcw, title: "Easy Returns", desc: "Not happy? Return within 14 days, no questions asked. Your satisfaction first." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>📱 WhatsApp: +961 70 000 000</li>
                <li>📧 info@primehome.lb</li>
