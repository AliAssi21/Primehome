      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col">
            ...
            <Button asChild variant="outline" size="lg" className="w-full rounded-full mb-6" disabled={product.stock === 0}>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span>Fast delivery across Lebanon. Free on orders over $50.</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground">
                <Shield className="h-4 w-4 text-primary shrink-0" />
                <span>Quality guaranteed. 14-day easy returns.</span>
              </div>
            </div>
          </motion.div>
        </div>
