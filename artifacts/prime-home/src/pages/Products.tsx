...
export default function Products() {
  ...
  const FilterPanel = () => (
    <div className="space-y-6">
      ...
      <Button variant="outline" size="sm" className="w-full" onClick={() => { setCategoryId(""); setPriceRange([0, 2000]); setOnSale(false); setFeatured(false); setSearch(""); setSort("newest"); setPage(1); }}>
        Clear Filters
      </Button>
    </div>
  );
